    ...
    <div class="uk-padding-large">
        <div class="toolbar uk-align-right uk-margin-remove">
            <div class="uk-button-group">
                ...
                <a href="<?=base_url('index.php/Perusahaan/formPerusahaan')?>" class="uk-button uk-button-small uk-button-primary left-radial" >Tambah</a>
            </div>
        </div>
        <div>
                    ...
                    <?php
                        foreach ($list as $key) { ?>
                            <tr>
                                ...
                                <td><?=$key->kontak_perusahaan?></td>
                                <td><?=$key->email_perusahaan?></td>
                                <td>
                                    <a href="<?=base_url('index.php/Perusahaan/editPerusahaan/'.$key->perusahaan_id)?>">edit</a> /
                                    <a href="<?=base_url('index.php/Perusahaan/hapusPerusahaan/'.$key->perusahaan_id)?>">hapus</a>
                                </td>
                            </tr>
                    <?php } ?>
                </tbody>
