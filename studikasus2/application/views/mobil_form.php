    ...
    <div class="uk-padding-large">
        <form class="uk-width-large" method="post" onsubmit="processData()">
            ...
            <fieldset class="uk-fieldset">
                ...
                <div class="uk-margin">
                    <input class="uk-input" type="text" placeholder="Nama mobil" id="nama_mobil">
                </div>

                <div class="uk-margin">
                    <input class="uk-input" type="date" placeholder="Tanggal release" id="tanggal_release">
                </div>

                <div class="uk-margin">
                    <input class="uk-input" type="number" placeholder="Harga" id="harga">
                </div>
...
function processData() {
    ...
    $.ajax({
            url: '<?=base_url('index.php/Mobil/addMobil')?>',
            method: "POST",
            dataType: "json",
            data: {
