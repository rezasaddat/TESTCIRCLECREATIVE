    ...
    <div class="uk-padding-large">
        <form class="uk-width-large" method="post" onsubmit="processData()">
            ...
            <fieldset class="uk-fieldset">
                ...
                <div class="uk-margin">
                    <input class="uk-input" type="text" placeholder="Nama Perusahaan" id="nama_perusahaan" value="<?=$perusahaan->nama_perusahaan?>">
                </div>

                <div class="uk-margin">
                    <input class="uk-input" type="number" placeholder="Kontak Perusahaan" id="kontak_perusahaan" value="<?=$perusahaan->kontak_perusahaan?>">
                </div>

                <div class="uk-margin">
                    <input class="uk-input" type="email" placeholder="Email Perusahaan" id="email_perusahaan" value="<?=$perusahaan->email_perusahaan?>">
                </div>
...
function processData() {
    ...
    $.ajax({
            url: '<?=base_url('index.php/Perusahaan/updatePerusahaan/'.$perusahaan->perusahaan_id)?>',
            method: "POST",
            dataType: "json",
            data: {
